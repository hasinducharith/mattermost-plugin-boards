...
const ItpTimeRecorder = ({ board, card }: Props) => {
    ...
    const fetchTaskStatus = async () => {
        ...
        try {
            const response = await fetch('https://mm2kimai-staging.itplace.io/timerecord', {
                method: 'POST',
    ...
    const handleStop = async() => {
        ...
        await fetch('https://mm2kimai-staging.itplace.io/timerecord',{
            method: 'POST',
            body: JSON.stringify(obj),
            headers: {
                'Content-type': 'application/json; charset=UTF-8',
    ...
    const getAddedTimeRecords = async () => {
        ...
        try {
            const response = await fetch('https://mm2kimai-staging.itplace.io/timerecord?type=getdata&cardId=' + cardId +'&userid=' + userid ,{
                method: 'GET',
                headers: {
                    'Content-type': 'application/json; charset=UTF-8',
                },
    ...
    const removeSlot = async(timesheetId:number) => { 
        ...
        try {
            const response = await fetch('https://mm2kimai-staging.itplace.io/timerecord?type=delete&timesheet_id=' + timesheetId, {
                method: 'GET',
                headers: {
                    'Content-type': 'application/json; charset=UTF-8',
                },
